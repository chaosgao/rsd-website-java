...
<div class="formbody">
    ...
    <form action="${pageContext.request.contextPath}/sysUser/insert" method="post">
        <ul class="forminfo">
            ...
            <li><label>真实姓名</label><input name="realName" type="text" class="dfinput" /><i>请输入真实姓名</i></li>
            ...
            <li><label>手机号码</label><input name="tel" type="text" class="dfinput" /><i>请输入手机号码</i></li>
