...
<div class="formbody">
    ...
    <form action="${pageContext.request.contextPath}/sysFunction/insert" method="post">
        <ul class="forminfo">
            <li><label>权限名称</label><input name="name" type="text" class="dfinput" /><i>请输入权限名称</i></li>
            <li><label>路径</label><input name="url" type="text" class="dfinput" /><i>路径</i></li>
